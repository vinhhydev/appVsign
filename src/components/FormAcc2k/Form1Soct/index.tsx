...
const Form1Soct = (data: IDataBaoCao) => {
  ...
  return (
    <ScrollView style={formStyles.container}>
      ...
      <View style={formStyles.formPanel}>
        ...
        <View style={formStyles.rowLineContent}>
          <View style={formStyles.leftLineHalf}>
            <Text style={formStyles.text}>Mã đầu tư: </Text>
            <TextInput style={formStyles.formTextInput} value={data.ma} />
          </View>
        </View>
        <View style={formStyles.rowLineContent}>
          <View style={formStyles.leftLineHalf}>
            <Text style={formStyles.text}>Mã nhân viên: </Text>
            <TextInput style={formStyles.formTextInput} value={data.ma} />
          </View>
        </View>
        <View style={formStyles.rowLineContent}>
          <View style={formStyles.leftLineHalf}>
            <Text style={formStyles.text}>Mã tài sản: </Text>
            <TextInput style={formStyles.formTextInput} value={data.ma} />
          </View>
        </View>
      </View>
