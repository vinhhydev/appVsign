...
const Form5Bke = (data: IDataBaoCao) => {
  ...
  return (
    <ScrollView style={formStyles.container}>
      ...
      <View style={formStyles.formPanel}>
        <View style={formStyles.rowLineTitle}>
          <Text style={formStyles.formTitleText}>Hàng hóa</Text>
        </View>
        <View style={formStyles.rowLineContent}>
          <View style={formStyles.leftLineHalf}>
          ...
          <View style={formStyles.rightLineHalf}>
            <Text style={formStyles.text}>TK đối ứng: </Text>
            <TextInput style={formStyles.formTextInput} value={''} />
          </View>
        </View>
        ...
        <View style={formStyles.rowLineContent}>
          <View style={formStyles.leftLineHalf}>
            <Text style={formStyles.text}>Kho: </Text>
            <TextInput style={formStyles.formTextInput} value={''} />
          </View>
        </View>
        <View style={formStyles.rowLineContent}>
        ...
        <View style={formStyles.rowLineContent}>
          <View style={formStyles.leftLineHalf}>
            <Text style={formStyles.text}>Nhóm vật tư: </Text>
            <TextInput style={formStyles.formTextInput} value={''} />
          </View>
        </View>
        ...
        <View style={formStyles.rowLineContent}>
          <View style={formStyles.leftLineHalf}>
            <Text style={formStyles.text}>Vật tư: </Text>
            <TextInput
              style={formStyles.formTextInput}
              value={vatTu}
              onChangeText={text => setVatTu(text)}
            />
            <TouchableOpacity
              style={formStyles.touchLoadmore}
              onPress={() => {
        ...
        <View style={formStyles.rowLineContent}>
          <View style={formStyles.leftLineHalf}>
            <Text style={formStyles.text}>Đối tượng: </Text>
            <TextInput
              style={formStyles.formTextInput}
              value={doiTuong}
              onChangeText={text => setDoiTuong(text)}
            />
            <TouchableOpacity
              style={formStyles.touchLoadmore}
              onPress={() => {
        ...
        <View style={formStyles.rowLineContent}>
          <View style={formStyles.leftLineHalf}>
            <Text style={formStyles.text}>Mã nhập xuất: </Text>
            <TextInput style={formStyles.formTextInput} value={''} />
          </View>
        </View>
      </View>
